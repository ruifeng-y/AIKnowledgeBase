export const ERROR_CODES = {
  ...
  INVALID_RERANK_CANDIDATE_K: 'INVALID_RERANK_CANDIDATE_K',
  RERANKER_PROVIDER_ERROR: 'RERANKER_PROVIDER_ERROR',
  RERANKER_INVALID_RESPONSE: 'RERANKER_INVALID_RESPONSE',
  INVALID_SEARCH_QUERY: 'INVALID_SEARCH_QUERY',
  INVALID_CONTEXT_TOP_K: 'INVALID_CONTEXT_TOP_K',
  INVALID_CONTEXT_TOKEN_BUDGET: 'INVALID_CONTEXT_TOKEN_BUDGET',
  LLM_PROVIDER_ERROR: 'LLM_PROVIDER_ERROR',
  LLM_EMPTY_RESPONSE: 'LLM_EMPTY_RESPONSE',
  INVALID_CITATION_REFERENCE: 'INVALID_CITATION_REFERENCE',
  GROUNDED_RESPONSE_VALIDATION_FAILED: 'GROUNDED_RESPONSE_VALIDATION_FAILED',
